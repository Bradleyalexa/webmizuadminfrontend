...
import { InvoiceTemplate, InvoiceData } from '../../admin/invoices/mockup3/InvoiceTemplate';
  ...
  try {
    ...
    return new NextResponse(pdfBuffer as any, {
      headers: {
        ...
        'Content-Disposition': `attachment; filename="Invoice3_${data.invoiceNo.replace(/[^a-zA-Z0-9]/g, '-')}.pdf"`,
      },
    });
