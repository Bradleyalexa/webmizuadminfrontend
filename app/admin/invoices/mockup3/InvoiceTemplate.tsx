...
export function InvoiceTemplate({ data }: { data: InvoiceData }) {
  ...
  const styles = `
    ...
    /* Reset and Global Overrides for #invoice-mockup3-root */
    #invoice-mockup3-root * {
      box-sizing: border-box;
    }
    
    #invoice-mockup3-root p {
      margin: 0;
      padding: 0;
    }
    ...
    #invoice-mockup3-root a { color: inherit; text-decoration: none; }
    #invoice-mockup3-root ol, #invoice-mockup3-root ul { list-style: none; }
    #invoice-mockup3-root table { border-collapse: collapse; border-spacing: 0; }
    #invoice-mockup3-root h1, #invoice-mockup3-root h2, #invoice-mockup3-root h3, 
    #invoice-mockup3-root h4, #invoice-mockup3-root h5, #invoice-mockup3-root h6 { font-weight: bold; margin-top: 0; margin-bottom: 0; }
    
    #invoice-mockup3-root .group:before,
    #invoice-mockup3-root .group:after { content: " "; display: table; }
    #invoice-mockup3-root .group:after { clear: both; }
    #invoice-mockup3-root .group { zoom: 1; }
    
    #invoice-mockup3-root embed, #invoice-mockup3-root img, #invoice-mockup3-root object { max-width: 100%; }
    
    /* Layout Classes */
    #invoice-mockup3-root .global_container_ {
      float: none;
    ...
    #invoice-mockup3-root .header {
      left: 66px;
      margin: 0 auto;
      position: relative;
      width: 2330px;
    }
    #invoice-mockup3-root .col-3 {
      float: left;
      margin: 15px 0 0;
      position: relative;
      width: 337px;
    }
    #invoice-mockup3-root .wrapper-6 {
      height: 307px;
      position: relative;
      width: 337px;
    }
    #invoice-mockup3-root .layer-239 { left: 50%; position: absolute; top: 201px; margin-left: -117.5px; }
    #invoice-mockup3-root .layer-239-copy { left: 50%; position: absolute; top: 142px; margin-left: -168.5px; }
    #invoice-mockup3-root .layer-239-copy-2 { left: 50%; position: absolute; top: 173px; margin-left: -141.5px; }
    #invoice-mockup3-root .layer-242 { left: 50%; position: absolute; top: 0; margin-left: -136.5px; }
    
    #invoice-mockup3-root .text {
      margin: 1px 119px 0 69px;
      font-size: 58.33px;
      line-height: 50px;
      text-align: center;
    }
    #invoice-mockup3-root .col-8 {
      float: right;
      position: relative;
      width: 1981px;
    }
    #invoice-mockup3-root .text-2 { display: block; margin: 0 0 0 4px; position: relative; }
    #invoice-mockup3-root .text-3 {
      margin: 34px 0 0 5px;
      position: relative;
      font-family: 'Segoe UI', Frutiger, 'Frutiger Linotype', 'Dejavu Sans', 'Helvetica Neue', Arial, sans-serif;
      font-weight: bold;
    }
    #invoice-mockup3-root .text-4 {
      margin: -4px 0 0 7px;
      position: relative;
      font-family: 'Segoe UI', Frutiger, 'Frutiger Linotype', 'Dejavu Sans', 'Helvetica Neue', Arial, sans-serif;
      font-weight: bold;
    }
    #invoice-mockup3-root .row-2 { margin: 10px 0 0; position: relative; }
    #invoice-mockup3-root .col-10 { float: left; position: relative; width: 1299px; }
    #invoice-mockup3-root .text-5 {
      font-family: 'Segoe UI', Frutiger, 'Frutiger Linotype', 'Dejavu Sans', 'Helvetica Neue', Arial, sans-serif;
      font-size: 41.67px;
    }
    #invoice-mockup3-root .text-6 {
      margin: 2px 0 0 7px;
      font-family: 'Segoe UI', Frutiger, 'Frutiger Linotype', 'Dejavu Sans', 'Helvetica Neue', Arial, sans-serif;
      font-size: 41.67px;
      line-height: 50px;
    }
    #invoice-mockup3-root .text-7 {
      margin: 0px 0 0 0px;
      font-family: 'Segoe UI', Frutiger, 'Frutiger Linotype', 'Dejavu Sans', 'Helvetica Neue', Arial, sans-serif;
      font-size: 41.67px;
    }
    #invoice-mockup3-root .text-8 {
      float: right;
    ...
    #invoice-mockup3-root .text-9 {
      margin: 0 489px;
      color: #000000;
      font-weight: bold;
    }
    
    #invoice-mockup3-root .text-10 {
    ...
    #invoice-mockup3-root .text-10-extra {
    ...
    #invoice-mockup3-root .text-11,
    #invoice-mockup3-root .text-12,
    #invoice-mockup3-root .text-13 {
        color: #000000;
        font-weight: bold;
    }
    ...
    #invoice-mockup3-root .text-15 {
      color: #000000;
      font-weight: bold;
      text-align: right;
    }
    #invoice-mockup3-root .shape-8 {
      height: 5px;
      left: 50%;
      position: absolute;
      top: 79px;
        ...
        <div className="global_container_">
          ...
          <div className="wrapper">
            <div className="col-2">
              ...
              {data.row4 && <p className="text-10-extra" style={{ position: 'absolute', top: '570px', left: '525px', whiteSpace: 'nowrap' }}>{data.row4}</p>}
              ...
              {data.row7 && (
                 <p className="text-12" style={{ position: 'absolute', top: '785px', left: '650px', width: '2000px', margin: 0, whiteSpace: 'nowrap' }}>
                   {data.row7}
                 </p>
              )}
