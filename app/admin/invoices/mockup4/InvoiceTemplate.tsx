...
export function InvoiceTemplate({ data }: { data: InvoiceData }) {
  ...
  const styles = `
    ...
    #invoice-mockup4-root {
      ...
      /* Essential for consistent mobile rendering of fixed-width content */
    ...
    #invoice-mockup4-root h1, #invoice-mockup4-root h2, #invoice-mockup4-root h3, 
    #invoice-mockup4-root h4, #invoice-mockup4-root h5, #invoice-mockup4-root h6 { font-weight: bold; margin-top: 0; margin-bottom: 0; }
    
    #invoice-mockup4-root .group:before,
    #invoice-mockup4-root .group:after { content: " "; display: table; }
    #invoice-mockup4-root .group:after { clear: both; }
    #invoice-mockup4-root .group { zoom: 1; }
    
    #invoice-mockup4-root embed, #invoice-mockup4-root img, #invoice-mockup4-root object { max-width: 100%; }
    
    /* Layout Classes */
    #invoice-mockup4-root .global_container_ {
      float: none;
    ...
    #invoice-mockup4-root .header {
      left: 66px;
      margin: 0 auto;
      position: relative;
      width: 2330px;
    }
    #invoice-mockup4-root .col-3 {
      float: left;
      margin: 15px 0 0;
      position: relative;
      width: 337px;
    }
    #invoice-mockup4-root .wrapper-6 {
      height: 307px;
      position: relative;
      width: 337px;
    }
    #invoice-mockup4-root .layer-239 { left: 50%; position: absolute; top: 201px; margin-left: -117.5px; }
    #invoice-mockup4-root .layer-239-copy { left: 50%; position: absolute; top: 142px; margin-left: -168.5px; }
    #invoice-mockup4-root .layer-239-copy-2 { left: 50%; position: absolute; top: 173px; margin-left: -141.5px; }
    #invoice-mockup4-root .layer-242 { left: 50%; position: absolute; top: 0; margin-left: -136.5px; }
    
    #invoice-mockup4-root .text {
      margin: 1px 119px 0 69px;
      font-size: 58.33px;
      line-height: 50px;
      text-align: center;
    }
    #invoice-mockup4-root .col-8 {
      float: right;
      position: relative;
      width: 1981px;
    }
    #invoice-mockup4-root .text-2 { display: block; margin: 0 0 0 4px; position: relative; }
    #invoice-mockup4-root .text-3 {
      margin: 34px 0 0 5px;
      position: relative;
      font-family: 'Segoe UI', Frutiger, 'Frutiger Linotype', 'Dejavu Sans', 'Helvetica Neue', Arial, sans-serif;
      font-weight: bold;
    }
    #invoice-mockup4-root .text-4 {
      margin: -4px 0 0 7px;
      position: relative;
      font-family: 'Segoe UI', Frutiger, 'Frutiger Linotype', 'Dejavu Sans', 'Helvetica Neue', Arial, sans-serif;
      font-weight: bold;
    }
    #invoice-mockup4-root .row-2 { margin: 10px 0 0; position: relative; }
    #invoice-mockup4-root .col-10 { float: left; position: relative; width: 1299px; }
    #invoice-mockup4-root .text-5 {
      font-family: 'Segoe UI', Frutiger, 'Frutiger Linotype', 'Dejavu Sans', 'Helvetica Neue', Arial, sans-serif;
      font-size: 41.67px;
    }
    #invoice-mockup4-root .text-6 {
      margin: 2px 0 0 7px;
      font-family: 'Segoe UI', Frutiger, 'Frutiger Linotype', 'Dejavu Sans', 'Helvetica Neue', Arial, sans-serif;
      font-size: 41.67px;
      line-height: 50px;
    }
    #invoice-mockup4-root .text-7 {
      margin: 0px 0 0 0px;
      font-family: 'Segoe UI', Frutiger, 'Frutiger Linotype', 'Dejavu Sans', 'Helvetica Neue', Arial, sans-serif;
      font-size: 41.67px;
    }
    #invoice-mockup4-root .text-8 {
      float: right;
    ...
    #invoice-mockup4-root .text-15 {
      color: #000000;
      font-weight: bold;
      text-align: right;
    }
    #invoice-mockup4-root .shape-8 {
      height: 5px;
      left: 50%;
      position: absolute;
      top: 79px;
