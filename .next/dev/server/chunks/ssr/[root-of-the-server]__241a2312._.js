...
function MockupInvoicePage() {
    ...
    const handleExportClientPDF = async ()=>{
        try {
            const element = document.getElementById('invoice-mockup-root');
            if (!element) return;
            // Use html2canvas to capture the element
            const canvas = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$adminFE$2f$node_modules$2f$html2canvas$2f$dist$2f$html2canvas$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])(element, {
                scale: 2,
                useCORS: true,
                logging: false,
                width: 2552,
            ...
            // A4 Landscape dimensions in points (approx)
            ...
            pdf.save(`Invoice_Client_${data.invoiceNo.replace(/[^a-zA-Z0-9]/g, '-')}.pdf`);
        } catch (err) {
            console.error('Client PDF Export Error:', err);
            alert('Failed to generate client-side PDF.');
        }
    };
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$adminFE$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        style: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__241a2312._.js.map