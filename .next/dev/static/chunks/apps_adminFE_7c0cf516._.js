...
"[project]/apps/adminFE/src/features/reports/components/technician-payout-detail.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function TechnicianPayoutDetail({ technicianId, startDate, endDate }) {
    ...
    const [logs, setLogs] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$adminFE$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    const [totalFee, setTotalFee] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$adminFE$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$adminFE$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "TechnicianPayoutDetail.useEffect": ()=>{
            if (!session || !technicianId) return;
            const fetchData = {
                "TechnicianPayoutDetail.useEffect.fetchData": async ()=>{
                    setLoading(true);
                    try {
            ...
            `).eq('technician_id', technicianId).gte('service_date', startDate).lte('service_date', endDate).order('service_date', {
                            ...
                            const rawIds = currentLogs.map({
                                "TechnicianPayoutDetail.useEffect.fetchData.rawIds": (l)=>l.customer_product_id
                            ...
                            if (cpIds.length > 0) {
                                ...
                                if (!cpError && cpData) {
                                    ...
                                    const cpMap = {};
                                    cpData.forEach({
                                        "TechnicianPayoutDetail.useEffect.fetchData": (item)=>{
                                            cpMap[item.id] = item;
                                        }
                                    }["TechnicianPayoutDetail.useEffect.fetchData"]);
                            ...
                            const total = currentLogs.reduce({
                                "TechnicianPayoutDetail.useEffect.fetchData.total": (acc, log)=>acc + Number(log.teknisi_fee || 0)
                            }["TechnicianPayoutDetail.useEffect.fetchData.total"], 0);
                            setTotalFee(total);
                        }
                    } catch (err) {
                        console.error("Fetch Data Error:", err);
                        __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$adminFE$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Failed to load details: " + err.message);
                    } finally{
                        setLoading(false);
                    }
                }
...
_s(TechnicianPayoutDetail, "UmKFHVqtptxFf4j/yzuPMlhKC3k=", false, function() {
    return [
...
_c = TechnicianPayoutDetail;
var _c;
__turbopack_context__.k.register(_c, "TechnicianPayoutDetail");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=apps_adminFE_7c0cf516._.js.map